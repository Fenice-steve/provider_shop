...
//  List<dynamic> bxMallSubDto; // 小表列表
//  String image; // 类别图片
//  Null comments; // 列表描述
//
//  // 构造函数
...
//}
//
//class CategoryBigModelList {
//  List<CategoryBigModel> data;
//
//  CategoryBigModelList(this.data);
//
//  factory CategoryBigModelList.formJson(List json) {
//    return CategoryBigModelList(
